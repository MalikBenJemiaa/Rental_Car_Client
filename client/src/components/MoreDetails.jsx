...
const MoreDetails = () => {
  ...
  useEffect(() => {
      axios.get(`http://localhost:5000/api/cars/${selectedCarId}`)
      .then((res) => {
    ...
    <label htmlFor="star1" title="1">1</label>
                    ...
                    <p className="font-light capitalize text-gray-600 leading-6 mt-3">{carDetails.carDesc}</p>
                    ...
                    <div className="lg:mt-4 mt-10">
                        ...
                        <div className=" block flex-row justify-between items-center mt-4">
                            <p className="font-medium text-base leading-4 capitalize text-gray-600"><span className='text-gray-500'>Car Category :</span> {carDetails.carCategory}</p><br/>
                            <p className="font-medium text-base leading-4 capitalize text-gray-600"><span className='text-gray-500'>Car Location :</span> {carDetails.carLocation}</p><br/>
                            <p className="font-light capitalize text-gray-600 tracking-wide leading-5"><span className='text-gray-500'>Car Specs :</span> {carDetails.carSpecs}</p><br/>
                            <p className="font-medium text-base leading-4 capitalize text-gray-600"><span className='text-gray-500'>Car Engine Type :</span> {carDetails.carEngineType}</p><br/>
                            <p className="font-medium text-base leading-4 capitalize text-gray-600"><span className='text-gray-500'>Car Passenger Capacity :</span> {carDetails.carPassengerCapacity}</p><br/>
                        </div>
                ...
                >
                  ...
                  <span className="relative w-full text-center transition-colors duration-200 ease-in-out group-hover:text-black uppercase text-xl">
                    Rent a car
                  </span>
                </a>
                </div>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    ...
                    <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                        <div className="flex justify-center items-center border">
                            <img  src={carDetails.carIMG2} alt={carDetails.carName}/>
                        </div>
                        <div className="flex justify-center border items-center">
                            <img  src={carDetails.carIMG3} alt={carDetails.carName}/>
                        </div>
                        <div className="flex justify-center border items-center">
                            <img  src={carDetails.carIMG4} alt={carDetails.carName}/>
                        </div>
                    </div>
                    </div>
                </div>
